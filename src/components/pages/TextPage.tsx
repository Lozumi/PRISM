            ...
            <div className="flex items-start justify-between mb-4">
                ...
                {config.pdf && !embedded && (
                    <a
                        href={config.pdf}
                        download
                        className="flex items-center space-x-2 px-4 py-2 bg-accent hover:bg-accent-dark text-white rounded-lg transition-colors duration-200 font-medium text-sm whitespace-nowrap ml-4"
                    >
